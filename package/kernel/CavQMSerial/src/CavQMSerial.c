...
// Debug flag
static ulong debug = 1;

static const struct usb_device_id CavConfigVIDPIDTable[] = {
    /* Match the specific device with either:
     * - Interface 2 (AT) 
     * - Interface 3 (GNSS)
     */
    { 
        USB_DEVICE_INTERFACE_NUMBER(C10QM_VID, C10QM_PID, C10QM_AT_INTF_NUM),
        .driver_info = (kernel_ulong_t)"AT_Interface"
    },
    { 
        USB_DEVICE_INTERFACE_NUMBER(C10QM_VID, C10QM_PID, C10QM_GNSS_INTF_NUM),
        .driver_info = (kernel_ulong_t)"GNSS_Interface"
    },
    { } /* Terminating entry */
};
